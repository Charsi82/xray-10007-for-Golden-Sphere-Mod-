...
// »справление отображени€ параметра "отношение" при обыске тел монстров
...
void CUICharacterInfo::InitCharacter(u16 id)
{
	...
	if (pUIBio && pUIBio->IsEnabled())
	{
		...
		if (chInfo.Bio().size())
		{
			...
			// »справление работы статика биографии
...
// 				m_icons[eUIIcon]->SetColor	(color_argb(255,255,160,160));
			...
			// »справление заливки иконки красным цветом при обыске тел монстров и людей
